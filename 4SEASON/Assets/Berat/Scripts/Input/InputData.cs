...
namespace PlayerInput
{
    ...
    public class InputData : ScriptableObject
    {
        ...
        public string ANIMATION_RUN = "Run";
        ...
        [SerializeField] private KeyCode NegativeHorizontalKeyCod;
        ...
        public virtual void ProcessInput()
        {
            ...
            else
            {
                ...
                {
                    KeyBaseAxisControl(ref Horizontal, PositiveHorizontalKeyCode, NegativeHorizontalKeyCod);
                }
